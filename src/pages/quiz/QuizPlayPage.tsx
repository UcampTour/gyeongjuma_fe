            ...
            >
              ...
              >
                {[
                  {
                    label: "남은 문항",
                    val: `${quizDetailData.totalQuestions - currentIdx}문항`,
                  },
            ...
            >
              ...
              >
                ...
                >
                  정답률{" "}
                  {Math.round(
                    (correctCnt / quizDetailData.totalQuestions) * 100,
                  )}
                  %
                </Typography>
              </Box>
              ...
              <Box sx={{ display: "flex", gap: 1.5, mt: "auto", pt: 1 }}>
                ...
                <Button
                  ...
                  fullWidth
                  startIcon={<ListIcon />}
                  onClick={() => handleComplete(() => setStage("result"))}
                  sx={{
                    borderRadius: "20px",
                    py: 2,
                    bgcolor: "#A08E73",
